...
query <- paste0( 
  ...
  WHERE { 
  ?s <http://purl.org/linked-data/cube#dataSet> <http://gmdatastore.org.uk/data/households-with-lone-parent-not-in-employment> . 
  <http://gmdatastore.org.uk/data/households-with-lone-parent-not-in-employment> <http://purl.org/dc/terms/description> ?measure.
...
households_with_lone_parent_not_in_employment <- SPARQL(endpoint, query)$results %>% 
